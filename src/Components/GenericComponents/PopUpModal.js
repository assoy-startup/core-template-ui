...
const PopUpModal=observer((props)=>{
    ...
    return(
        ...
        >
            <DialogTitle className={classes.dialogHeading} ><div className="rowFlex spaceBetween"><div>Filters</div><div><CloseIcon onClick={props.cancel}/></div></div></DialogTitle>
            <DialogContent>
                <hr/>
              <div className="rowFlex spaceEvenly">
                <div>
                 <LocalizationProvider dateAdapter={AdapterDayjs}>
                    <DemoContainer components={['DatePicker']}>
                        <DatePicker label="Select Date"  sx={{border:'solid 2px'}}/>
                    </DemoContainer>
                ...
                <Select
                    ...
                    sx={{border:'solid 2px',minWidth: 120,marginTop:'8px'}}
                    >
                    <MenuItem value={10}>ALL Branch</MenuItem>
                    <MenuItem value={10}>Branch One</MenuItem>
                    <MenuItem value={20}>Branch Two</MenuItem>
                    </Select>
                </div>
              </div>
