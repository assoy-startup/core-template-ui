...
const HomeComponent = observer((props) => {
  ...
  return (
    <>
      ...
      >
        <div
          className="rowFlex spaceAround"
          style={{ background: "#18243c", height: "7vh" }}
        >
          <div style={{ color: "white", alignSelf: "center" }}>
            <i className="bi bi-envelope"></i> info@casacare.in
          </div>
          <div style={{ color: "white", alignSelf: "center" }}>
            <i className="bi bi-facebook" /> <i className="bi bi-twitter" />{" "}
            <i className="bi bi-linkedin" /> <i className="bi bi-google" />
          </div>
        </div>
        <div
          className="rowFlex spaceAround flexCenter"
          style={{ background: "grey", height: "7vh" }}
        >
          <div style={{ alignSelf: "center" }}>
            <img src={Images.ASSOY} style={{ width: "10vw", height: "5vh" }} />
          </div>
